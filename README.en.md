...
dsh plugin --profile web add '@dsh-external/dsh-minigames@github:dsh-external/dsh-minigames#v0.3.12'
...
> 1. Run `dsh plugin --profile web add '@dsh-external/dsh-minigames@github:dsh-external/dsh-minigames#v0.3.12'` (the first run may fail because pnpm 11 blocks node-pty build scripts)
